...
export default function Geo() {
  ...
  const loadGeoData = async () => {
    var geodata = japan.features;
    var mercator = d3.geoMercator().center([136.0, 35.6]);
    ...
    for (let i = 0; i < geodata.length; i++) {
      ...
      var gmesh = transformSVGPath(feature);
      for (let j = 0; j < gmesh.length; j++) {
        arr.push({ data: properties, mesh: gmesh[j] });
      }
    }
    setCountries(arr);
  };
